...
@section('title', __('app.admin_login_title') . ' — ' . __('app.app_name'))

@section('content')
<div class="max-w-sm mx-auto">
    <div class="text-center mb-8">
        <div class="text-4xl mb-3">🔑</div>
        <h1 class="text-2xl font-bold text-gray-800">{{ __('app.admin_login_title') }}</h1>
