                ...
                <li class="px-6 py-5">
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            ...
                            {{-- WhatsApp button — shown after draw --}}
                            @if($group->is_drawn && $participant->assignedTo)
                            @php
                            ...
                            <a
                                href="{{ $waUrl }}"
                                target="_blank"
                                class="inline-flex items-center gap-1 mt-2 px-3 py-1.5 rounded-lg bg-green-500 hover:bg-green-600 text-white text-xs font-medium transition"
                            >
